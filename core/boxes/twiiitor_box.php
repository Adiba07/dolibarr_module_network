 ...
 */
class twiiitorbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "twiiitor@twiiitor";
    public $boxlabel;
    public $depends = array("twiiitor");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/twiiitor/class/twiiitor.class.php";
