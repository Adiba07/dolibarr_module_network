 ...
 */
class networkbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "network@network";
    public $boxlabel;
    public $depends = array("network");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/network/class/network.class.php";
